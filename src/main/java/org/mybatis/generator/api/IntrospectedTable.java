...
public abstract class IntrospectedTable {
    ...
    protected void calculateXmlAttributes() {
        ...
        setSelectByPrimaryKeyStatementId("getById"); //zhouzongkun
        ...
        setUpdateByPrimaryKeyStatementId("updateById"); // modify by zhouzongkun
        setUpdateByPrimaryKeySelectiveStatementId("updateByIdWithSelective"); //$NON-NLS-1$
    ...
    protected void calculateJavaClientAttributes() {
        ...
        sb.append('.');
        sb.append(fullyQualifiedTable.getDomainObjectName());
        sb.append("Dao"); //modify by zhouzongkun
    ...
    protected void calculateModelAttributes() {
        ...
        sb.append('.');
        sb.append(fullyQualifiedTable.getDomainObjectName());
        sb.append("DO"); // modify by zhouzongkun
    ...
    protected String calculateMyBatis3XmlMapperFileName() {
        StringBuilder sb = new StringBuilder();
        sb.append(fullyQualifiedTable.getDomainObjectName());
        sb.append("Dao.xml"); // modify by zhouzongkun
        return sb.toString();
    }
